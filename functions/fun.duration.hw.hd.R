d.int <- function(intensity.s) {
  ...
  mask <- aggregateGrid(intensity.s, aggr.y = list(FUN = "mean", na.rm = TRUE))
  mask$Data[!is.na(mask$Data)] = 1

  list_total_c1_num <- gridArithmetics(list_total_c1_num, mask, operator = "*")
  list_total_c1_median <- gridArithmetics(list_total_c1_median, mask, operator = "*")
  list_total_c2_num <- gridArithmetics(list_total_c2_num, mask, operator = "*")
  list_total_c2_median <- gridArithmetics(list_total_c2_median, mask, operator = "*")
  list_total_c3_num <- gridArithmetics(list_total_c3_num, mask, operator = "*")
  list_total_c3_median <- gridArithmetics(list_total_c3_median, mask, operator = "*")
  list_total_c4_num <- gridArithmetics(list_total_c4_num, mask, operator = "*")
  list_total_c4_median <- gridArithmetics(list_total_c4_median, mask, operator = "*")
  ...
  return(list("num"= list_num, "median"= list_median))
}